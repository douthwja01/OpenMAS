...
% Adapted from the 'point2trimesh.m' function written by Daniel Frisch.
% Ammendments were made to make the evaluation of collisions more
% sophisticated.

function [ distances, surface_points, faces2, vertices2, corresponding_vertices_ID, new_faces_ID ] = OMAS_evaluateSeparation( varargin )
% -------------------------------------------------------
%
