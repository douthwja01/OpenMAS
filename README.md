...
| <img src="resources/quadcopter-example.gif" height="320" title="Quadcopter dynamics example"> Quadcopter dynamics
| <img src="resources/boids-example.gif" height="320" title="Boids example"> Boids flocking|
| --- | --- |
