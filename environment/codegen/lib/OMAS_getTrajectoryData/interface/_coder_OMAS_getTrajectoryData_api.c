 ...
 * File: _coder_OMAS_getTrajectoryData_api.c
 *
...
emlrtContext emlrtContextGlobal = { true,/* bFirstTime */
  ...
  NULL,                                /* fErrorFunction */
  "OMAS_getTrajectoryData",            /* fFunctionName */
  NULL,                                /* fRTCallStack */
  false,                               /* bDebugMode */
...
static void c_emlrt_marshallIn(const emlrtStack *sp, const mxArray
  *globalIDvector, const char_T *identifier, emxArray_uint8_T *y);
static void d_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  emlrtMsgIdentifier *parentId, emxArray_uint8_T *y);
static uint8_T e_emlrt_marshallIn(const emlrtStack *sp, const mxArray *objectID,
  const char_T *identifier);
static void emlrt_marshallIn(const emlrtStack *sp, const mxArray
  *trajectoryMatrix, const char_T *identifier, emxArray_real_T *y);
...
static real32_T g_emlrt_marshallIn(const emlrtStack *sp, const mxArray *step,
  const char_T *identifier);
  ...
  *globalIDvector, const char_T *identifier, emxArray_uint8_T *y)
{
  ...
  d_emlrt_marshallIn(sp, emlrtAlias(globalIDvector), &thisId, y);
  emlrtDestroyArray(&globalIDvector);
}
  ...
  const char_T *identifier)
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  y = f_emlrt_marshallIn(sp, emlrtAlias(objectID), &thisId);
...
/*
 * Arguments    : const emlrtStack *sp
 *                const mxArray *trajectoryMatrix
 *                const char_T *identifier
 *                emxArray_real_T *y
 * Return Type  : void
 */
  ...
  *trajectoryMatrix, const char_T *identifier, emxArray_real_T *y)
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  b_emlrt_marshallIn(sp, emlrtAlias(trajectoryMatrix), &thisId, y);
  emlrtDestroyArray(&trajectoryMatrix);
}
  ...
  const char_T *identifier)
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  y = h_emlrt_marshallIn(sp, emlrtAlias(step), &thisId);
  ...
  emlrtMsgIdentifier *msgId, emxArray_uint8_T *ret)
{
  ...
  int32_T iv2[2];
  emlrtCheckVsBuiltInR2012b(sp, msgId, src, "uint8", false, 2U, dims, &bv1[0],
    iv2);
  ret->size[0] = iv2[0];
  ret->size[1] = iv2[1];
  ret->allocatedSize = ret->size[0] * ret->size[1];
 ...
 * Return Type  : void
 */
void OMAS_getTrajectoryData_api(const mxArray * const prhs[4], int32_T nlhs,
  const mxArray *plhs[2])
{
  ...
  emxInit_real_T(&st, &trajectoryMatrix, 2, true);
  emxInit_uint8_T(&st, &globalIDvector, 2, true);
  emxInit_real_T(&st, &objectStateData, 2, true);

  /* Marshall function inputs */
  emlrt_marshallIn(&st, emlrtAlias(prhs[0]), "trajectoryMatrix",
                   trajectoryMatrix);
  c_emlrt_marshallIn(&st, emlrtAlias(prhs[1]), "globalIDvector", globalIDvector);
  objectID = e_emlrt_marshallIn(&st, emlrtAliasP(prhs[2]), "objectID");
  step = g_emlrt_marshallIn(&st, emlrtAliasP(prhs[3]), "step");

  /* Invoke the target function */
  OMAS_getTrajectoryData(trajectoryMatrix, globalIDvector, objectID, step,
    objectStateData, &indexOfLastState);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(objectStateData);
  objectStateData->canFreeData = false;
  emxFree_real_T(&st, &objectStateData);
  globalIDvector->canFreeData = false;
  emxFree_uint8_T(&st, &globalIDvector);
  trajectoryMatrix->canFreeData = false;
  emxFree_real_T(&st, &trajectoryMatrix);
  if (nlhs > 1) {
    plhs[1] = b_emlrt_marshallOut(indexOfLastState);
  }
 ...
 * Return Type  : void
 */
void OMAS_getTrajectoryData_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  OMAS_getTrajectoryData_xil_terminate();
}
 ...
 * Return Type  : void
 */
void OMAS_getTrajectoryData_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
 ...
 * Return Type  : void
 */
void OMAS_getTrajectoryData_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/*
 * File trailer for _coder_OMAS_getTrajectoryData_api.c
 *
 * [EOF]
 */
