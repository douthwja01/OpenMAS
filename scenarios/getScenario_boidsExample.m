...
[ ~, agentConfig ] = testScenario.regularSphere('radius',scenarioConfig.agentOrbit,...
...
waypointScenario = scenarioBuilder(scenarioConfig.waypoints);
[ ~,waypointConfig ] = waypointScenario.helix('radius',scenarioConfig.waypointOrbit);
