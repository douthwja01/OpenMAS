function [ objectIndex ] = getScenario_formation_randomAgentsRegularObstacles(varargin)
...
fprintf('[SCENARIO]\tGetting a scenario with a random spherical distribution \n of agents, with regularly spherically distributed obstacles  scenario.\n');

% DEFAULT CONFIGURATION
defaultConfig = struct('file','scenario.mat',...
                       'agents',[],...
                       'agentOrbit',20,...
                       'obstacles',4,...                                   % Minimum required to demonstrate 3D
                       'obstacleRadius',2,...
                       'obstacleOrbit',10,...
                       'velocities',0,...
...
% [ obstacleConfigA ] = obstacleScenario.regularSphere('velocities',0,...
%                                                          'radius',inputConfig.obstacleOrbit);                                              
