function [ objectIndex ] = getScenario_UKACC_concentric(varargin)
...
%     waypointIndex{index}.VIRTUAL.globalPosition = waypointConfig.position(:,index) + inputConfig.noiseFactor*randn(3,1);
    waypointIndex{index}.VIRTUAL.globalPosition = waypointConfig.position(:,index) + inputConfig.noiseFactor*[randn(2,1);0];
