%% FORMATION - COLLISION AVOIDANCE (HRVO) AGENT (agent_formation_HRVO.m) %%
% This program contains a generic agent object with the 2017 3D geometric
% avoidance alogorithm applied to conduct course corrections.

% Author: James A. Douthwaite

classdef agent_formation_HRVO < agent_formation_seperation & agent_HRVO 
