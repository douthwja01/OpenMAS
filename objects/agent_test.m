...
%%  CLASS METHODS
    methods 
        ...
        function [obj] = processTimeCycle(obj,TIME,varargin)
            ...
            desiredHeading = desiredVelocity/desiredSpeed;
            ...
            %% INACT AVOIDANCE CORRECTION
            % PLOT THE BODY AXIS SCENE
            fileName = sprintf('testAgent[%s]',obj.name);
            if obj.objectID == visualiseAgent && visualiseProblem == 1
...
%             [a_angular(1)] = obj.boundValue(a_angular(1),-obj.angularAccelerationLimits(1),obj.angularAccelerationLimits(1));
%             [a_angular(2)] = obj.boundValue(a_angular(2),-obj.angularAccelerationLimits(2),obj.angularAccelerationLimits(2));
%             [a_angular(3)] = obj.boundValue(a_angular(3),-obj.angularAccelerationLimits(3),obj.angularAccelerationLimits(3));
%             
%             dV = a_angular*dt;
