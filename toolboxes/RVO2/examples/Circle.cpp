...
//sf::RenderWindow window(sf::VideoMode(800, 800), "EvoSimulator");
...
void setPreferredVelocities(RVO::RVOSimulator *sim, std::ofstream& stream)
{
	/*
...
int main()
{
	std::ofstream outputFile2("output2.csv");
...
#endif
		setPreferredVelocities(sim, outputFile2);
		sim->doStep();
	}
